...
export function Home() {
  ...
  <div className="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
      ...
      <div className="container-fluid">
        ...
        <a className="navbar-brand py-lg-2 mb-lg-5 px-lg-6 me-0" href="#">
          <img
            ...
            alt=""
          />
           <h4 className="text-primary">Sistema de Ventas</h4>
        </a>
        {/* User menu (mobile) */}
        ...
        <div className="collapse navbar-collapse" id="sidebarCollapse">
          ...
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="bi bi-bar-chart" /> Clientes
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="bi bi-chat" /> Proveedores
            ...
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="bi bi-bookmarks" /> Productos
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="bi bi-people" /> Ventas
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="bi bi-file-earmark-text" /> Compras
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">
            ...
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="bi bi-file-earmark-text" /> Configuracion
              </a>
            </li>
    ...
    <div className="h-screen flex-grow-1 overflow-y-lg-auto">
      {/* Header */}
      <header className="bg-surface-primary border-bottom pt-6 p-3">
        <div className="container-fluid">
          <div className="mb-npx">
            <div className="row align-items-center">
              ...
              {/* Actions */}
              <div className="col-sm-6 col-12 text-sm-end d-flex justify-content-end">
                <div className="mx-n1">
                  <a
                    href="#"
